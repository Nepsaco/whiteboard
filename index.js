...
// in a perfect grid. You arrived ten minutes too early 
// to an appointment, so you decided to take the opportunity 
// to go for a short walk. The city provides its 
// citizens with a Walk Generating App on their phones -- 
...
// that will return true if the walk the app gives you will take 
...
function isValidWalk(walk) {
    let northSouthWalked = 0
    let eastWestWalked = 0
    ...
    if(walk.length === 10){
        ...
        if(northSouthWalked === 0 && eastWestWalked === 0) {
            return true
        } else {
            return false
        }
